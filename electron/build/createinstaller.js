...
var electron_winstaller_1 = require("electron-winstaller");
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, electron_winstaller_1.createWindowsInstaller)({
                        ...
                        setupExe: "".concat(pkg.name, "-").concat(pkg.version, ".exe"),
                        setupMsi: "".concat(pkg.name, "-").concat(pkg.version, ".msi"),
                        noMsi: true,
